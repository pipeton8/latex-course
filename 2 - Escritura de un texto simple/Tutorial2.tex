...
% Los márgenes de la página se ajustan de esta manera (los números están dados
% y pueden jugar con ellos si quieren para ver que hacen):
...
% Ahora, si vemos el texto, podemos notar que todo el teorema tiene la letra
% en itálicas (o cursiva), a diferencia del texto de la demostración
% Esto es porque el teorema se encuentra dentro de un ``entorno''
% Los entornos permiten escribir partes del texto de una manera particular
% y con ciertas configuraciones. En este caso, el entorno en el que se
% encuentra el teorema, escribe el texto en cursiva y enumera el teorema.
% Para crear un entorno de teorema nuevo escribimos:
...
% LaTeX es tonto con los paréntesis. No sabe detectar automáticamente cuando algo es
% demasiado grande para los paréntesis. Para ello usamos \left y \right. Estos comandos
