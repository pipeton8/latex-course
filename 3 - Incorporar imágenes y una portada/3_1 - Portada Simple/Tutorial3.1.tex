...
% Primero debemos decirle a LaTeX cual es el título, quién es el autor y, opcionalmente,
% cuál es la fecha. Si esta última no se especifica, LaTeX asume la fecha del día en que se compila
% el texto.
